...
// To start the game, this function logs the mystery word, builds the blank line hidden divs and builds the keyboard
function startGame(word) {
	console.log(word)
	buildLines(word)
	buildKeyboard()
}
// This function checks if a letter is in the mystery word. If so, it removes the hidden class from those divs. If not, it adds to the error count. It also checks if the error count is too great and the game is over.
...
// Here we call the startGame function with a random word from the array. This is what we see when the page refreshes.
